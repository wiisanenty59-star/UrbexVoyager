    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <div className="w-full max-w-md relative z-10 space-y-8 p-8 border border-border/50 bg-card/40 backdrop-blur-sm">
        <div className="space-y-2 text-center">
          <h1 className="text-4xl font-serif text-primary uppercase tracking-widest glitch-text" data-text="VOYAGER">
            VOY<span className="text-foreground">AGER</span>
          </h1>
          <p className="text-sm font-mono text-muted-foreground uppercase tracking-widest">
            Invite-Only. Urban Exploration Network.
          </p>
        </div>
